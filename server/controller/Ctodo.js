...
exports.updateTodo = async (req, res) => {
    ...
    try {
        ...
        let [idUpdated] = await Todo.update(
            ...
            {
                where: {
                    id: {[Op.eq] : req.params.todoId }, // 경로 파라미터에서 'todoId'를 사용해서 특정 Todo 항목을 찾아라 
                    // op.eq는 sequelized의 연산자로, 'equals(같음)' 라는 뜻
                },
            },
        );
        // 수정 실패
        ...
        // 업데이트 된 항목이 없으면 'false'를 빈환
        }
        // 수정 성공
        res.send(true);        
        // 업데이트 된 항목이 없으면 'true'를 빈환
